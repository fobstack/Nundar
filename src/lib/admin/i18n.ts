...
const MESSAGES = {
  en: {
    ...
    setup: {
      ...
      lead: "Create the owner account. This is the only account that can change settings and manage administrators.",
      confirm: "Confirm password",
      passwordHint: "At least 12 characters. There is no password reset without a command line, so store it somewhere you will not lose it.",
      submit: "Create owner account",
      raceWarning:
        "Anyone who reaches this page before you do becomes the owner. Complete setup now, while the address is still unknown.",
      mismatch: "The two passwords do not match.",
      weak: "Use at least 12 characters.",
      invalidEmail: "That does not look like an email address.",
      alreadyDone: "This shop already has an owner.",
    },
    overview: {
      title: "Overview",
      ...
      needsYou: "Needs you",
      allClear: "All clear",
      allClearNote: "No orders waiting and nothing below its minimum order quantity.",
      oversoldNote: "Paid, but the stock was gone. Refund and contact the buyer.",
      pendingNote: "Payment not confirmed yet.",
      belowMoq: "Below minimum order",
      belowMoqNote: "Nobody can order these until stock rises above the MOQ.",
      noRevenue: "No paid orders yet.",
    },
    products: {
      title: "Products",
  ...
  zh: {
    ...
    setup: {
      title: "初始化你的店铺",
      lead: "创建所有者账号。只有这个账号能修改设置和管理其他管理员。",
      confirm: "确认密码",
      passwordHint: "至少 12 位。没有命令行就无法重置密码，请妥善保存。",
      submit: "创建所有者账号",
      raceWarning:
        "在你之前访问到本页的人会成为所有者。请现在就完成设置，趁地址还没有被任何人知道。",
      mismatch: "两次输入的密码不一致。",
      weak: "密码至少 12 位。",
      invalidEmail: "这不像是一个邮箱地址。",
      alreadyDone: "这个店铺已经有所有者了。",
    },
    overview: {
      title: "概览",
      signedInAs: "当前登录",
      ...
      needsYou: "需要处理",
      allClear: "暂无待办",
      allClearNote: "没有等待处理的订单，也没有低于起订量的 SKU。",
      oversoldNote: "已收款但库存已售完。请退款并联系买家。",
      pendingNote: "付款尚未确认。",
      belowMoq: "低于起订量",
      belowMoqNote: "库存回升到起订量以上前，这些 SKU 无法下单。",
      noRevenue: "还没有已付款的订单。",
    },
    products: {
      title: "商品",
