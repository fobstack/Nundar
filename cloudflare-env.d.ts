/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 4e3ac47d2f91ba317c165a7eab7951e7)
// Runtime types generated with workerd@1.20260831.1 2026-08-22 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	EMAIL: SendEmail;
	ASSETS: Fetcher;
	NEXT_CACHE_DO_QUEUE: DurableObjectNamespace<import("./src/worker").DOQueueHandler>;
	NEXT_TAG_CACHE_DO_SHARDED: DurableObjectNamespace<import("./src/worker").DOShardedTagCache>;
	NEXT_CACHE_DO_PURGE: DurableObjectNamespace<import("./src/worker").BucketCachePurge>;
